...
class FRCWorkbenchWidget(QtWidgets.QWidget):
    ...
    def __init__(self, viewer: napari.Viewer, parent=None):
        ...
        fr.addRow(self.chk_raw)
        fr.addRow("Max points to display (0=off):", self.sp_max_points)
        fr.addRow("Split method:", self.cb_method)
        fr.addRow("Block size (frames):", self.sp_block)
        fr.addRow("Random seed:", self.sp_seed)
    ...
    def _apply_compact_mode(self, advanced: bool):
        ...
        for w in (self.chk_raw, self.sp_max_points, self.cb_method, self.sp_block, self.sp_seed):
            w.setVisible(bool(advanced))
